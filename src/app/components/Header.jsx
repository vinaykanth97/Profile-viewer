            ...
            <div className="container mx-auto px-4 py-6">
                <div className="flex justify-between items-center">
                    ...
                    <div className="essentials flex items-center gap-8">
                        <div className="relative border-zink-100 border-solid border-2 rounded-[10px]">
                            ...
                            <input type="text" id="input-group-1" className="pl-10 pr-[110px] py-2.5 border-opacity-0 text-black rounded-[10px]" placeholder="Search" />
                        ...
                        <div className="notification relative">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M5.26904 9.75001C5.26779 8.86087 5.44246 7.98026 5.783 7.15891C6.12354 6.33757 6.62321 5.5917 7.25323 4.96429C7.88326 4.33688 8.63119 3.84031 9.45395 3.5032C10.2767 3.16608 11.158 2.99507 12.0472 3.00001C15.7597 3.02814 18.7315 6.11251 18.7315 9.83439V10.5C18.7315 13.8563 19.4347 15.8063 20.0534 16.875C20.1191 16.9888 20.1538 17.1179 20.1539 17.2494C20.154 17.3808 20.1196 17.5099 20.0541 17.6239C19.9886 17.7378 19.8943 17.8325 19.7806 17.8985C19.667 17.9646 19.538 17.9996 19.4065 18H4.59404C4.46261 17.9996 4.33361 17.9646 4.21996 17.8985C4.10632 17.8325 4.01201 17.7378 3.9465 17.6239C3.88099 17.5099 3.84656 17.3808 3.84668 17.2494C3.8468 17.1179 3.88145 16.9888 3.94716 16.875C4.56591 15.8063 5.26904 13.8563 5.26904 10.5V9.75001Z" stroke="#71717A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                                <path d="M9 18V18.75C9 19.5456 9.31607 20.3087 9.87868 20.8713C10.4413 21.4339 11.2044 21.75 12 21.75C12.7956 21.75 13.5587 21.4339 14.1213 20.8713C14.6839 20.3087 15 19.5456 15 18.75V18" stroke="#71717A" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
                            </svg>
                            <span className="inline-flex items-center justify-center px-2 py-1 mr-2 text-xs font-bold leading-none text-red-100 bg-[#EC4899] text-zink-100 rounded-full absolute top-[-10px] right-[-22px]">9</span>
                        </div>
